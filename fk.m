...
T_base(x, y, theta, d) = [ cos(theta)   , -sin(theta) , 0 , x;
...
% T(q1,q2,q3,q4,q5,q6,q7,q8,q9,q10) = T_base(q1, q2, q3, 1.0065) * ...            %base_link
%                                     T1(pi +q4 , 0, 0, pi/2) * ...   % base_link          -> arm_left_base_link
...
%                                     T1(q10, 0, 0, -pi/2)                                
% T(q1,q2,q3) = T1(0, q1 , 0, -pi/2) * ...            %base_link
%               T1(0 ,q2 , 0, pi/2) * ...
%               T1(q3, 0,0,0);
% T(q1,q2,q3) = T1(q3, 0 , 0, 0) * ...
%               T1(0, q1 , 0, 0) * ...            %base_link
%               T1(0 ,q2 , 0, 0);
